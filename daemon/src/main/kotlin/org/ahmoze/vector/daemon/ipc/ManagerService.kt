...
import org.ahmoze.vector.lspd.ILSPManagerService
...
import org.ahmoze.vector.daemon.env.Dex2OatServer
import org.ahmoze.vector.daemon.env.LogcatMonitor
import org.ahmoze.vector.daemon.system.*
import org.ahmoze.vector.daemon.utils.applyXspaceWorkaround
import org.ahmoze.vector.daemon.utils.getRealUsers
...
object ManagerService : ILSPManagerService.Stub() {
  ...
  class ManagerGuard(private val binder: IBinder, val pid: Int, val uid: Int) :
    ...
    private val connection =
        object : android.app.IServiceConnection.Stub() {
          ...
          override fun connected(name: ComponentName?, service: IBinder?, session: Any?, dead: Boolean) {}
        }
  ...
  private fun getManagerIntent(): Intent? {
    ...
    runCatching {
          ...
          intent.addCategory("org.ahmoze.vector.manager.LAUNCH_MANAGER")
  ...
  override fun performDexOptMode(packageName: String) =
      org.ahmoze.vector.daemon.utils.performDexOptMode(packageName)
