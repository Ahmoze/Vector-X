...
import org.ahmoze.vector.impl.VectorLifecycleManager
import org.ahmoze.vector.impl.hooks.freezeHooks
import org.ahmoze.vector.impl.hooks.getActiveHookHandles
import org.ahmoze.vector.impl.hooks.unfreezeHooks
import org.ahmoze.vector.impl.hooks.unhookAllModuleHooks
    ...
    private fun injectXposedService(
        ...
        runCatching {
            ...
            val onBinderReceivedMethod =
                helperClass.getDeclaredMethod("onBinderReceived", android.os.IBinder::class.java)
