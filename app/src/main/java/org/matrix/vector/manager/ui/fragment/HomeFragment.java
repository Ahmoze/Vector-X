...
import org.matrix.vector.manager.databinding.DialogAboutBinding;
import org.matrix.vector.manager.databinding.FragmentHomeBinding;
import org.matrix.vector.manager.ui.dialog.BlurBehindDialogBuilder;
import org.matrix.vector.manager.util.NavUtil;
import org.matrix.vector.manager.util.UpdateUtil;
import org.matrix.vector.manager.util.chrome.LinkTransformationMethod;
            ...
            if (needUpdate) {
                ...
                binding.updateBtn.setOnClickListener(v -> {
                    ...
                    if (zipPath != null && new java.io.File(zipPath).exists()) {
                        new org.matrix.vector.manager.ui.dialog.BlurBehindDialogBuilder(activity)
