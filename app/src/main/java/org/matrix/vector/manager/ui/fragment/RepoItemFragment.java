...
package org.matrix.vector.manager.ui.fragment;
...
import org.matrix.vector.manager.databinding.FragmentPagerBinding;
import org.matrix.vector.manager.databinding.ItemRepoLoadmoreBinding;
import org.matrix.vector.manager.databinding.ItemRepoReadmeBinding;
import org.matrix.vector.manager.databinding.ItemRepoRecyclerviewBinding;
import org.matrix.vector.manager.databinding.ItemRepoReleaseBinding;
import org.matrix.vector.manager.databinding.ItemRepoTitleDescriptionBinding;
import org.matrix.vector.manager.repo.RepoLoader;
import org.matrix.vector.manager.repo.model.Collaborator;
import org.matrix.vector.manager.repo.model.OnlineModule;
import org.matrix.vector.manager.repo.model.Release;
import org.matrix.vector.manager.repo.model.ReleaseAsset;
import org.matrix.vector.manager.ui.dialog.BlurBehindDialogBuilder;
import org.matrix.vector.manager.ui.widget.EmptyStateRecyclerView;
import org.matrix.vector.manager.ui.widget.LinkifyTextView;
import org.matrix.vector.manager.util.AccessibilityUtils;
import org.matrix.vector.manager.util.NavUtil;
import org.matrix.vector.manager.util.SimpleStatefulAdaptor;
import org.matrix.vector.manager.util.chrome.CustomTabsURLSpan;
