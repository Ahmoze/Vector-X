...
import org.ahmoze.vector.manager.databinding.FragmentPagerBinding;
import org.ahmoze.vector.manager.databinding.ItemRepoLoadmoreBinding;
import org.ahmoze.vector.manager.databinding.ItemRepoReadmeBinding;
import org.ahmoze.vector.manager.databinding.ItemRepoRecyclerviewBinding;
import org.ahmoze.vector.manager.databinding.ItemRepoReleaseBinding;
import org.ahmoze.vector.manager.databinding.ItemRepoTitleDescriptionBinding;
import org.ahmoze.vector.manager.repo.RepoLoader;
import org.ahmoze.vector.manager.repo.model.Collaborator;
import org.ahmoze.vector.manager.repo.model.OnlineModule;
import org.ahmoze.vector.manager.repo.model.Release;
import org.ahmoze.vector.manager.repo.model.ReleaseAsset;
import org.ahmoze.vector.manager.ui.dialog.BlurBehindDialogBuilder;
import org.ahmoze.vector.manager.ui.widget.EmptyStateRecyclerView;
import org.ahmoze.vector.manager.ui.widget.LinkifyTextView;
import org.ahmoze.vector.manager.util.AccessibilityUtils;
import org.ahmoze.vector.manager.util.NavUtil;
import org.ahmoze.vector.manager.util.SimpleStatefulAdaptor;
import org.ahmoze.vector.manager.util.chrome.CustomTabsURLSpan;
